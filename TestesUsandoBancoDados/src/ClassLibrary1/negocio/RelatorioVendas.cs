...
namespace SistemaVendas.Negocio
{
    public class RelatorioVendas
    {
        ...
        public RelatorioVendas(ISession _session)
        {
        ...
        {
            var query = "select sum(vv.valor)  from venda v inner join VendaVendedor vv on vv.IdVenda = v.IdVenda where vv.IdVendedor = :idVendedor and year(v.dataVenda)= :ano";
